...
const checkedJuridica = ref(false)
const checkedNatural = ref(false)
</script>
...
<template>
    <div>
        ...
        <div class="flex gap-4 mt-8 items">
            ...
            <input class="text-white/60" value="true" type="checkbox" name="natural" v-model="checkedNatural" id="natural">
            <label class="text-white" for="natural">Natural</label>
            <input class="text-white/60" type="checkbox" value="true" name="juridica" v-model="checkedJuridica" id="juridica">
            <label class="text-white" for="juridica">Jurídica</label>
        </div>
        <form class="flex flex-col mt-4 mb-2">
            <label v-if="checkedNatural === true" class="text-white">Nombre</label>
